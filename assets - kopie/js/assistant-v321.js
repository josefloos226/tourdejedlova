...
const intents=[
 ...
 {id:"profile",score:9,keys:["profil trate","profil trasy","nastoupani","vyskove metry","stoupani","kopce","tezka trat","tezka trasa","obtizna trat","obtizna trasa","narocna trat","narocna trasa","obtiznost","narocnost"],answer:()=>"Trať má přibližně 10 km a převýšení kolem 400 m+. Je krátká, ale převýšením intenzivní. Nejtěžší část přichází ve druhé třetině závodu při stoupání směrem na Jedlovou. Povrch kombinuje asfalt a nezpevněné/štěrkové úseky."},
